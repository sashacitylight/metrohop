...
(function(jQuery){
	...
	var SliderKit = function() {
		...
		this.change = function( btn, scrollWay, forcedId, lineScroll, stopAuto ) {
			...
			// By default, newuser action is blocked when nav is being animated. This to prevent the function calculation to go mad when the newuser is switching the items too quickly.
