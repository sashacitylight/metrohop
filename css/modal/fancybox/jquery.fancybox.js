...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		showLoading: function () {
			...
			// If newuser will press the escape-button, the request will be canceled
	...
	F.helpers.overlay = {
		defaults : {
			closeClick : true,  // if true, fancyBox will be closed when newuser clicks on the overlay
