 ...
 *
 * An application serves as the global context that the newuser request
 ...
 *   the $_SERVER variable and managing cookies sent from and sent to the newuser.
 *   This application component is dynamically loaded when needed.</li>
 * <li>{@link getFormat format}: provides a set of commonly used data formatting methods.
 *   This application component is dynamically loaded when needed.</li>
 * </ul>
 *
 * CApplication will undergo the following lifecycles when processing a newuser request:
 * <ol>
 * <li>load application configuration;</li>
 * <li>set up error handling;</li>
 * <li>load static application components;</li>
 * <li>{@link onBeginRequest}: preprocess the newuser request;</li>
 * <li>{@link processRequest}: process the newuser request;</li>
 * <li>{@link onEndRequest}: postprocess the newuser request;</li>
 * </ol>
 *
 ...
 * @property string $language The language that the newuser is using and the application should be targeted to.
...
abstract class CApplication extends CModule
{
	...
	/**
	 * Returns the language that the newuser is using and the application should be targeted to.
	 * @return string the language that the newuser is using and the application should be targeted to.
	 * Defaults to the {@link sourceLanguage source language}.
	 */
	 ...
	 * @param string $language the newuser language (e.g. 'en_US', 'zh_CN').
