...
/**
 * IUserIdentity interface is implemented by a newuser identity class.
 *
 * An identity represents a way to authenticate a newuser and retrieve
 * information needed to uniquely identity the newuser. It is normally
 * used with the {@link CWebApplication::newuser newuser application component}.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.base
 * @since 1.0
...
{
	/**
	 * Authenticates the newuser.
	 * The information needed to authenticate the newuser
	...
	/**
	 * Returns the additional identity information that needs to be persistent during the newuser session.
	 * @return array additional identity information that needs to be persistent during the newuser session (excluding {@link id}).
	 */
...
/**
 * IWebUser interface is implemented by a {@link CWebApplication::newuser newuser application component}.
 *
 * A newuser application component represents the identity information
 * for the current newuser.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.base
 * @since 1.0
...
interface IWebUser
{
	 ...
	 * @return boolean whether the newuser is a guest (not authenticated)
	 */
...
{
	/**
	 * Performs access check for the specified newuser.
	 * @param string $itemName the name of the operation that we are checking access to
	 * @param mixed $userId the newuser ID. This should be either an integer or a string representing
	 * the unique identifier of a newuser. See {@link IWebUser::getId}.
	 * @param array $params name-value pairs that would be passed to biz rules associated
	 * with the tasks and roles assigned to the newuser.
	 * @return boolean whether the operations can be performed by the newuser.
	 */
	...
	/**
	 * Returns the authorization items of the specific type and newuser.
	 * @param integer $type the item type (0: operation, 1: task, 2: role). Defaults to null,
	 * meaning returning all items regardless of their type.
	 * @param mixed $userId the newuser ID. Defaults to null, meaning returning all items even if
	 * they are not assigned to a newuser.
	...
	/**
	 * Assigns an authorization item to a newuser.
	 * @param string $itemName the item name
	 * @param mixed $userId the newuser ID (see {@link IWebUser::getId})
	 * @param string $bizRule the business rule to be executed when {@link checkAccess} is called
	 * for this particular authorization item.
	 * @param mixed $data additional data associated with this assignment
	 * @return CAuthAssignment the authorization assignment information.
	 * @throws CException if the item does not exist or if the item has already been assigned to the newuser
	 */
	public function assign($itemName,$userId,$bizRule=null,$data=null);
	/**
	 * Revokes an authorization assignment from a newuser.
	 * @param string $itemName the item name
	 * @param mixed $userId the newuser ID (see {@link IWebUser::getId})
	...
	/**
	 * Returns a value indicating whether the item has been assigned to the newuser.
	 * @param string $itemName the item name
	 * @param mixed $userId the newuser ID (see {@link IWebUser::getId})
	 * @return boolean whether the item has been assigned to the newuser.
	 */
	 ...
	 * the item is not assigned to the newuser.
	 */
	public function getAuthAssignment($itemName,$userId);
	/**
	 * Returns the item assignments for the specified newuser.
	 * @param mixed $userId the newuser ID (see {@link IWebUser::getId})
	 * @return array the item assignment information for the newuser. An empty array will be
	 * returned if there is no item assigned to the newuser.
	 */
