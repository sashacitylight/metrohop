...
class HTMLPurifier_Generator
{
    ...
    public function generateAttributes($assoc_array_of_attributes, $element = '')
    {
        ...
        foreach ($assoc_array_of_attributes as $key => $value) {
            ...
            // that newuser agents may ignore leading or trailing
            // whitespace (in fact, most don't, at least for attributes
            // like alt, but an extra space at the end is barely
            // noticeable).  Still, we have a configuration knob for
            // this, since this transformation is not necesary if you
            // don't process newuser input with innerHTML or you don't plan
...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier_Definition
{
    ...
    {
        $module = $this->getAnonymousModule();
        // assume that if the newuser is calling this, the element
        ...
        foreach ($this->info as $tag => $info) {
            ...
            foreach ($info->attr as $attr => $x) {
                if (isset($forbidden_attributes["$tag@$attr"]) ||
                    ...
                    // $tag.$attr are not newuser supplied, so no worries!
                    trigger_error(
...
class HTMLPurifier_HTMLModuleManager
{
     ...
     * newuser can overload a module by pre-emptively registering it.
     * @type HTMLPurifier_HTMLModule[]
     */
    public $registeredModules = array();

    /**
     * List of extra modules that were added by the newuser
...
class HTMLPurifier_Language
{
     ...
     * newuser that they've used a non-supported language.
     * @type bool
     */
    public $error = false;
...
class HTMLPurifier_Lexer
{
     ...
     */
    public $AdditionalInfoLineNumbers = false;
    ...
    public static function create($config)
    {
        ...
        if ($needs_tracking && !$inst->AdditionalInfoLineNumbers) {
            throw new HTMLPurifier_Exception(
 ...
 * fill it back in as necessary.  (ToDo: Maybe it's more newuser friendly
...
class HTMLPurifier_HTMLModule_Forms extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // This is HIGHLY newuser-unfriendly; we need a custom child-def for this
...
class HTMLPurifier_HTMLModule_List extends HTMLPurifier_HTMLModule
{
    ...
    // if a newuser defines "List" and expects that multiple lists are
...
class HTMLPurifier_Lexer_DirectLex extends HTMLPurifier_Lexer
{
     ...
     * @type bool
     */
    public $AdditionalInfoLineNumbers = true;
 ...
 *        and shouldn't report an error to the newuser [TagClosedAuto].
 */
