 ...
 * Generates the 'post' controller which should be located under
   the 'admin_old' subdirectory of the base controller path:
        controller admin_old/post

 * Generates the 'post' controller which should belong to
   the 'admin_old' module:
        controller admin_old/post
...
Yii is able to detect whether 'admin_old' refers to a module or a subdirectory.
