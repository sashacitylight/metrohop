...
class CrudCommand extends CConsoleCommand
{
	 ...
	 */
	public $actions=array('create','update','index','view','admin_old','_form','_view','_search');
 ...
 * Generates CRUD for the Post model which belongs to module 'admin_old':
        crud admin_old.models.Post

 * Generates CRUD for the Post model. The generated controller should
   belong to module 'admin_old', but not the model class:
        crud Post admin_old/post
