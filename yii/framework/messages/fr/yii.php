...
return array (
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Le cache utilisateur CWinCache est désactivé. Veuillez définir la propriété wincache.ucenabled à On dans le fichier php.ini.',
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'L\'élément d\'Autorisation « {item} » a déjà été assigné à l\'utilisateur « {newuser} ».',
