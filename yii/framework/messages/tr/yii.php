...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => '"{item}" için gereçli olan yetkilendirme zaten "{newuser}" kullanıcısına atanmış durumda.',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache newuser cache pasif. Lütfen php.ini dosyasındaki wincache.ucenabled değerini On olarak değiştirin.',
