...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Item otorisasi "{item}" sudah ditempatkan kepada pengguna "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache newuser cache dinonaktifkan. Harap set wincache.ucenabled menjadi On pada php.ini anda.',
