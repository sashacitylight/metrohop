...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'عنصر التفويض "{item}" قد تم بالفعل تعيينه للمستخدم "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache الكاش الخاص بالمستخدم معطل. الرجاء إعداد wincache.ucenabled ليكون في وضع التشغيل في ملف php.ini.',
