...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Authorization item "{item}" đã được gán cho newuser "{newuser}" rồi.',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache newuser cache bị tắt. Xin thiết lập wincache.ucenabled là On trong php.ini của bạn.',
