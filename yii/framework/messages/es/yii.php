...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'El elemento de autorización "{item}" ya ha sido asignado con anterioridad al usuario "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'La caché de usuario de CWinCache está desactivada. Por favor, cambie wincache.ucenabled a On en su php.ini.',
