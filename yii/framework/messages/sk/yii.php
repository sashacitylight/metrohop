...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Autorizačný záznam "{item}" je už priradený užívateľovi "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache je deaktivovaná. Nastavte prosím wincache.ucenabled "On" v konfiguračnom súbore php.ini.',
