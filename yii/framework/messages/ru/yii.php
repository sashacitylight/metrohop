...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Элемент авторизации "{item}" уже назначен пользователю "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Пользовательский CWinCache отключен. Измените wincache.ucenabled на On в вашем php.ini.',
