...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Το αντικείμενο πιστοποίησης "{item}" έχει οριστεί στο χρήστη "{newuser}".',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'Η λανθάνουσα μνήμη χρήστη CWinCache είναι απενεργοποιημένη. Ορίστε το wincache.ucenabled στην τιμή On στο php.ini.',
