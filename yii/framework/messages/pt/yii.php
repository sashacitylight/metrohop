...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Item de autorização "{item}" já está assinado para o usuário "{newuser}".',
  ...
  'CSecurityManager requires PHP mcrypt extension to be loaded in order to use data encryption feature.' => 'CSecurityManager requer a extensão PHP mcrypt para ser carregado em ordem para newuser propriedades de criptografia de dados.',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'O cache de usuário do CWinCache está desabilitado. Por favor, configure wincache.ucenabled com o valor On em seu php.ini.',
