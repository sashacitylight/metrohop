...
return array (
  ...
  'Authorization item "{item}" has already been assigned to newuser "{newuser}".' => 'Brugeren "{newuser}" er allerede tildelt autorisationsobjektet "{item}"',
  ...
  'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache newuser cache er deaktiveret. Sæt venligst wincache.ucenabled til On i din php.ini.',
