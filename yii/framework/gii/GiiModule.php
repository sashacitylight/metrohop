...
class GiiModule extends CWebModule
{
	 ...
	 * This method will check to see if newuser IP and password are correct if they attempt
	...
	/**
	 * Checks to see if the newuser IP is allowed by {@link ipFilters}.
	 * @param string $ip the newuser IP
	 * @return boolean whether the newuser IP is allowed by {@link ipFilters}.
	 */
