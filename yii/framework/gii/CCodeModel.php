 ...
 * The purpose of a code model is to represent newuser-supplied parameters and use them to
 * generate customized code.
 *
 * Derived classes should implement the {@link prepare} method whose main task is to
 * fill up the {@link files} property based on the newuser parameters.
 *
 ...
 * that can remember its last valid value, even if the newuser closes his browser window
...
abstract class CCodeModel extends CFormModel
{
	...
	/**
	 * @var array newuser confirmations on whether to overwrite existing code files with the newly generated ones.
	 * The value of this property is internally managed by this class and {@link CCodeGenerator}.
	 */
	public $answers;
	/**
	 * @var string the name of the code template that the newuser has selected.
	 * The value of this property is internally managed by this class and {@link CCodeGenerator}.
	 */
	public $template;
	/**
	 ...
	 * This method validates whether the newuser selects an existing template
