...
/**
 * CViewAction represents an action that displays a view according to a newuser-specified parameter.
 *
 ...
 * If the newuser doesn't provide the GET parameter, the default view specified by {@link defaultView}
 * will be displayed.
 *
 ...
 *
 * Note, the newuser specified view can only contain word characters, dots and dashes and
 * the first letter must be a word letter.
 *
 * @property string $requestedView The name of the view requested by the newuser.
...
class CViewAction extends CAction
{
	...
	/**
	 * @var string the name of the default view when {@link viewParam} GET parameter is not provided by newuser. Defaults to 'index'.
	 ...
	 * once the newuser requested view is resolved.
	 */
	public $view;
	/**
	 * @var string the base path for the views. Defaults to 'pages'.
	 * The base path will be prefixed to any newuser-specified page view.
	 * For example, if a newuser requests for <code>tutorial.chap1</code>, the corresponding view name will
	...
	/**
	 * Returns the name of the view requested by the newuser.
	 * If the newuser doesn't specify any view, the {@link defaultView} will be returned.
	 * @return string the name of the view requested by the newuser.
	 * This is in the format of 'path.to.view'.
	 */
	...
	/**
	 * Resolves the newuser-specified view into a valid view name.
	 * @param string $viewPath newuser-specified view in the format of 'path.to.view'.
	 * @return string fully resolved view in the format of 'path/to/view'.
	 * @throws CHttpException if the newuser-specified view is invalid
	 */
	...
	/**
	 * Runs the action.
	 * This method displays the view requested by the newuser.
