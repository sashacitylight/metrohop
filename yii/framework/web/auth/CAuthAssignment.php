...
/**
 * CAuthAssignment represents an assignment of a role to a newuser.
...
class CAuthAssignment extends CComponent
{
	 ...
	 * @param mixed $userId newuser ID (see {@link IWebUser::getId})
	...
	/**
	 * @return mixed newuser ID (see {@link IWebUser::getId})
	 */
