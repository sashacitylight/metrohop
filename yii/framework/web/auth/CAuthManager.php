 ...
 * that may be assigned to individual users. A newuser is said to have a permission
 ...
 * at appropriate places in the application code to check if the current newuser
...
abstract class CAuthManager extends CApplicationComponent implements IAuthManager
{
	 ...
	 * These roles do not need to be explicitly assigned to any newuser.
	 ...
	 * it with a biz rule which checks if the current newuser is authenticated.
	 * And then declare 'authenticated' in this property so that it can be applied to
	 * every authenticated newuser.
	 */
	 ...
	 * @param mixed $userId the newuser ID. If not null, only the roles directly assigned to the newuser
	 ...
	 * Returns tasks.
	 * This is a shortcut method to {@link IAuthManager::getAuthItems}.
	 * @param mixed $userId the newuser ID. If not null, only the tasks directly assigned to the newuser
	 ...
	 * Returns operations.
	 * This is a shortcut method to {@link IAuthManager::getAuthItems}.
	 * @param mixed $userId the newuser ID. If not null, only the operations directly assigned to the newuser
