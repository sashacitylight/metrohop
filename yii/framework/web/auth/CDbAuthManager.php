...
class CDbAuthManager extends CAuthManager
{
	 ...
	 * @param mixed $userId the newuser ID. This should can be either an integer and a string representing
	 ...
	 * with the tasks and roles assigned to the newuser.
	 * Since version 1.1.11 a param with name 'userId' is added to this array, which holds the value of <code>$userId</code>.
	 * @param array $assignments the assignments to the specified newuser
	 * @return boolean whether the operations can be performed by the newuser.
	 * @since 1.1.3
	 */
