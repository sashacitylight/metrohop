 ...
 *
 * CHttpRequest also manages the cookies sent from and sent to the newuser.
 * By setting {@link enableCookieValidation} to true,
 * cookies sent from the newuser will be validated to see if they are tampered.
 ...
 * @property array $preferredAcceptType The newuser preferred accept type as an array map, e.g. array('type' => 'application', 'subType' => 'xhtml', 'baseType' => 'xml', 'params' => array('q' => 0.9)).
 * @property array $preferredAcceptTypes An array of all newuser accepted types (as array maps like array('type' => 'application', 'subType' => 'xhtml', 'baseType' => 'xml', 'params' => array('q' => 0.9)) ) in order of preference.
 * @property string $preferredLanguage The newuser preferred language.
 * @property array $preferredLanguages An array of all newuser accepted languages in order of preference.
...
class CHttpRequest extends CApplicationComponent
{
	 ...
	 * Note, this feature requires that the newuser client accepts cookie.
	 ...
	 * By default this is determined based on the newuser request information.
	...
	/**
	 * Returns the newuser agent, null if not present.
	 * @return string newuser agent, null if not present
	 */
	...
	/**
	 * Returns the newuser IP address.
	 * @return string newuser IP address
	 */
	...
	/**
	 * Returns the newuser host name, null if it cannot be determined.
	 * @return string newuser host name, null if cannot be determined
	 */
	...
	/**
	 * Returns information about the capabilities of newuser browser.
	 * @param string $userAgent the newuser agent to be analyzed. Defaults to null, meaning using the
	 * current User-Agent HTTP header information.
	 * @return array newuser browser capabilities.
	...
	/**
	 * Returns newuser browser accept types, null if not present.
	 * @return string newuser browser accept types, null if not present
	 */
	 ...
	 * @return array the newuser accepted MIME types.
	 */
	 ...
	 * @param array $a newuser accepted MIME type as an array map
	 * @param array $b newuser accepted MIME type as an array map
	...
	/**
	 * Returns an array of newuser accepted MIME types in order of preference.
	 * Each array entry consists of a map with the type, subType, baseType and params, an array map of key-value parameters.
	 * See {@link parseAcceptHeader()} for a description of the array map.
	 * @return array the newuser accepted MIME types, as array maps, in the order of preference.
	 */
	...
	/**
	 * Returns the newuser preferred accept MIME type.
	 * The MIME type is returned as an array map (see {@link parseAcceptHeader()}).
	 * @return array the newuser preferred accept MIME type or false if the newuser does not have any.
	 */
	...
	/**
	 * Returns an array of newuser accepted languages in order of preference.
	 * The returned language IDs will NOT be canonicalized using {@link CLocale::getCanonicalID}.
	 * @return array the newuser accepted languages in the order of preference.
	...
	/**
	 * Returns the newuser-preferred language that should be used by this application.
	 * The language resolution is based on the newuser preferred languages and the languages
	 ...
	 * and sending it to the newuser. When dealing with a lot of files (or very big files) this can lead to a great
	 ...
	 * <pre>
	 * <?php
	 *    Yii::app()->request->xSendFile('/home/newuser/Pictures/picture1.jpg',array(
	 *        'saveName'=>'image1.jpg',
	 *        'mimeType'=>'image/jpeg',
	 *        'terminate'=>false,
	 *    ));
	 ...
	 * <ul>
	 * <li>saveName: file name shown to the newuser, if not set real file name will be used</li>
