...
/**
 * CController manages a set of actions which deal with the corresponding newuser requests.
 *
 * Through the actions, CController coordinates the data flow between models and views.
 *
 * When a newuser requests an action 'XYZ', CController will do one of the following:
 ...
 *
 * If the newuser does not specify an action, CController will run the action specified by
 * {@link defaultAction}, instead.
 *
 * CController may be configured to execute filters before and after running actions.
 * Filters preprocess/postprocess the newuser request/response and may quit executing actions
...
class CController extends CBaseController
{
	 ...
	 * This is like {@link redirect}, but the newuser browser's URL remains unchanged.
	 ...
	 * The effect of this method call is the same as newuser pressing the
