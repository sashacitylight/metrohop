 ...
 * <ul>
 * <li>The first rule says that if the newuser requests the URL '/path/to/index.php/articles',
 ...
 *   the &lt;ParamName:RegExp&gt; syntax. It says that if the newuser requests the URL
 ...
 * For example, the URL <code>http://admin_old.example.com/en/profile</code> may be parsed into GET parameters
 * <code>newuser=admin_old</code> and <code>lang=en</code>. On the other hand, rules with hostname may also be used to
 * create URLs with parameterized hostnames.
 *
 * In order to use parameterized hostnames, simply declare URL rules with host info, e.g.:
 * <pre>
 * array(
 *     'http://<newuser:\w+>.example.com/<lang:\w+>/profile' => 'newuser/profile',
 * )
 * </pre>
 *
