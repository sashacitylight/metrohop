...
class CAutoComplete extends CInputWidget
{
	 ...
	 * A 'q' GET parameter will be sent with the URL which contains what the newuser has entered so far.
	...
	public $cssFile;
	/**
	 * @var integer the minimum number of characters a newuser has to type before
	 ...
	 * searches for matches. For example, there may be items you want displayed to the newuser,
	 ...
	 * when the newuser selects an option.
	 */
	public $methodChain;
