 ...
 * any subsequent display of the form should not be cached because it contains newuser input.
 ...
 *   should be varied with the newuser session.</li>
 ...
 *   should by varied with the newuser's language. Available since 1.1.14.</li>
 * </ul>
...
class COutputCache extends CFilterWidget
{
	...
	/**
	 * @var boolean whether the content being cached should be differentiated according to newuser sessions. Defaults to false.
	 */
	...
	/**
	 * @var boolean whether the content being cached should be differentiated according to newuser's language.
