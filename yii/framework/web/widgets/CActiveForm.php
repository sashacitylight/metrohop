 ...
 * CActiveForm will render the error in the page back to newuser.</li>
 * <li>AJAX-based validation: when the newuser enters data into an input field,
 ...
 * when the newuser enters data into an input field,
 ...
 * all these validations will lead to the same newuser interface changes and error
 * message content.
 *
 ...
 * Note that in order to make the latter two validations work, the newuser's browser
 ...
 * or separately. For example, in a newuser registration form, one may use AJAX-based
 * validation to check if the newuser has picked a unique username, and use client-side
 ...
 * {
 *     if(isset($_POST['ajax']) && $_POST['ajax']==='newuserForm')
 *     {
...
class CActiveForm extends CWidget
{
	 ...
	 * <li>validateOnType: boolean, whether to trigger an AJAX validation each time when the newuser
