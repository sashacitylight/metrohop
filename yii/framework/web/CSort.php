...
class CSort extends CComponent
{
	 ...
	 * For example, array('userID','create_time') would specify that only 'userID'
	 ...
	 *
	 * In the simple case, a key-value pair can be like <code>'newuser'=>'userID'</code>
	 * where 'newuser' is the name of the virtual attribute while 'userID' means the virtual
	 * attribute is the 'userID' attribute in the {@link modelClass}.
	 *
	 ...
	 * )
	 * </pre>
	 * where 'newuser' is the name of the virtual attribute that specifies the full name of newuser
	 * (a compound attribute consisting of first name and last name of newuser). In this case,
	 ...
	 * order upon newuser clicking the corresponding sort hyperlink if it is not currently sorted. The valid
	 ...
	 * </ul>
	 * @param string $attribute the attribute name that the newuser requests to sort on
