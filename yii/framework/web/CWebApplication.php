 ...
 * <li>{@link newuser}: represents the newuser session information.</li>
 ...
 * the actual newuser request. If the newuser does not specify controller ID, it will
 ...
 * @property CWebUser $newuser The newuser session information.
...
class CWebApplication extends CApplication
{
	 ...
	 *   ),
	 *   'newuser'=>'path.to.UserController',
	 * )
	 * </pre>
	 *
	 ...
	 * all newuser requests. This is mainly used when the application is in maintenance mode
	...
	/**
	 * @return CWebUser the newuser session information
	 */
	public function getUser()
	{
		return $this->getComponent('newuser');
	}
	 ...
	 * the corresponding controller. For example, if the route is "admin_old/newuser/create",
	 * then the controller will be created using the class file "protected/controllers/admin_old/UserController.php".</li>
	 * </ol>
