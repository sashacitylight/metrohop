 ...
 * when a newuser does not specify the action name in his command.
 *
...
abstract class CConsoleCommand extends CComponent
{
	 ...
	 *
	 * @param string $message to echo out before waiting for newuser input
	 * @param string $default the default string to be returned when newuser does not write anything.
	...
	/**
	 * Asks newuser to confirm by typing y or n.
	 *
	 * @param string $message to echo out before waiting for newuser input
	 ...
	 * @return boolean whether newuser confirmed
	 *
	 * @since 1.1.9
	 */
