...
class CCubridSchema extends CDbSchema
{
	...
	*/
	...
	protected function findTableNames($schema='')
	{
		...
		// If necessary newuser has to establish a connection to that particular database and
		// query to show all tables. For this reason if a newuser executes this funtion
