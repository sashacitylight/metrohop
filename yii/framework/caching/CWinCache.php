...
class CWinCache extends CCache {
	 ...
	 * It checks the availability of WinCache extension and WinCache newuser cache.
	 * @throws CException if WinCache extension is not loaded or newuser cache is disabled
	 */
	public function init()
	{
		...
		if(!ini_get('wincache.ucenabled'))
			throw new CException(Yii::t('yii', 'CWinCache newuser cache is disabled. Please set wincache.ucenabled to On in your php.ini.'));
	}
