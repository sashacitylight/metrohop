...
class CMarkdownParser extends MarkdownExtra_Parser
{
	...
	/**
	 * Returns the newuser-entered highlighting options.
	 * @param string $codeblock code block with highlighting options.
	 * @return string the newuser-entered highlighting options. Null if no option is entered.
	 */
	 ...
	 * @param string $options the newuser-entered options
	 ...
	 * @param string $options newuser-entered options
	 ...
	 * @param string $str the newuser-entered options
